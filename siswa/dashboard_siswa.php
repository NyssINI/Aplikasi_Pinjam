...
<head>
  ...
  <style>
    ...
    /* Pastikan burger button tersembunyi pada layar desktop */
...
<body class="bg-gray-100 dark:bg-gray-900 h-screen overflow-auto transition-colors duration-300 font-serif">
  ...
  <!-- Sidebar -->
  <div class="sidebar fixed z-50 top-16 bottom-0 left-0 lg:left-0 -left-72 p-2 w-[300px] overflow-y-auto text-center bg-white dark:bg-gray-800 shadow-md transition-all duration-300">
    <div class="text-gray-900 dark:text-gray-100 text-xl">
      <div class="p-2.5 mt-1 flex items-center">
        ...
        <!-- Tombol X untuk menutup sidebar (hanya di mobile) -->
  ...
  <!-- Burger Button (akan muncul hanya pada mobile) -->
  <button id="burger-btn" class="fixed top-20 left-4 z-30 lg:hidden bg-white dark:bg-gray-800 p-2 rounded shadow-md" onclick="Open()">
  ...
  <script>
    ...
    function Open() {
      ...
      // Sembunyikan burger button ketika sidebar terbuka
