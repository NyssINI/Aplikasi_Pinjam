    ...
    <nav class="bg-white dark:bg-gray-800 shadow-md fixed w-full z-20">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between h-16 items-center">
                <span class="text-xl font-bold text-gray-900 dark:text-gray-100">Dashboard Admin</span>
...
<!-- Sidebar -->
    <div class="sidebar fixed top-16 bottom-0 left-0 p-2 w-[300px] overflow-y-auto text-center bg-white dark:bg-gray-800 shadow-md transition-all duration-300">
        <div class="text-gray-900 dark:text-gray-100 text-xl">
            ...
            <a href="dashboard_admin.php" class="block">
            ...
            <a href="?page=tambah_barang" class="block">
                <div class="py-2.5 mt-3 flex items-center rounded-md px-4 cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700">
                    <i class="bi bi-database-add text-gray-700 dark:text-gray-300"></i>
                    <span class="text-[18px] ml-4">Tambah Barang</span>
                </div>
            </a>
            <hr class="border-gray-300 dark:border-gray-600 my-2">
            ...
            <div id="submenu" class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-900 dark:text-gray-100 overflow-hidden max-h-0 transition-all duration-300">
                <a href="?page=lab_rpl1" class="block">
                ...
                <a href="?page=lab_rpl2" class="block">
                    <div class="flex items-center cursor-pointer p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md mt-1">
                        <i class="bi bi-bar-chart text-gray-700 dark:text-gray-300"></i>
                        <h1 class="ml-4">Lab RPL 2</h1>
                    </div>
                </a>
                <a href="?page=lab_mm" class="block">
                    <div class="flex items-center cursor-pointer p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md mt-1">
                        <i class="bi bi-bar-chart text-gray-700 dark:text-gray-300"></i>
    ...
    <div class="pt-16 lg:ml-[320px] min-h-[calc(100vh-64px)]">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6">
            <a href="?page=tambah_barang" class="block" onclick="setLightTheme()">
                <div class="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 transition-transform duration-300 hover:scale-105 active:scale-100 hover:shadow-2xl">
                    <h3 class="text-xl font-bold mb-2 flex items-center">
                        <i class="bi bi-plus-circle mr-2 text-gray-700 dark:text-gray-300"></i>Tambah Barang
                    </h3>
                    <p>Masukkan barang di sini!</p>
                </div>
            </a>
            <a href="?page=lab_rpl1" class="block">
                <div class="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 transition-transform duration-300 hover:scale-105 active:scale-100 hover:shadow-2xl">
                    ...
                    <p>Data yang meminjam di sini!</p>
                </div>
            </a>
            <a href="?page=lab_rpl2" class="block">
                <div class="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 transition-transform duration-300 hover:scale-105 active:scale-100 hover:shadow-2xl">
        ...
        <div class="grid gap-6 p-6">
            <div class="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 p-6 rounded-2xl shadow-lg 
            border border-gray-200 dark:border-gray-700 min-h-[470px] flex flex-col justify-center items-center">
                <?php
                if (isset($_GET['page'])) {
                    $page = $_GET['page'];
                    switch ($page) {
                        case 'tambah_barang':
                            include "../content/tambah_barang.php";
                            break;
                        case 'lab_rpl1':
                            include "../content/Lab_RPL_1/lab_rpl1.php";
                            break;
                        case 'hapus_rpl1':
                            include "../content/Lab_RPL_1/hapus_laptop1.php";
                            break;
                        case 'edit_rpl1':
                            include "../content/Lab_RPL_1/edit_laptop1.php";
                            break;
                        case 'lab_rpl2':
                            include "../content/Lab_RPL_2/lab_rpl2.php";
                            break;
                        case 'hapus_rpl2':
                            include "../content/Lab_RPL_2/hapus_laptop2.php";
                            break;
                        case 'edit_rpl2':
                            include "../content/Lab_RPL_2/edit_laptop2.php";
                            break;
                        case 'lab_mm':
                            include "../content/Lab_MM/lab_mm.php";
                            break;
                        case 'edit_mm':
                            include "../content/Lab_MM/edit_barang.php";
                            break;
                        case 'hapus_mm':
                            include "../content/Lab_MM/hapus_barang.php";
                            break;
                        default:
                            echo "<h2 class='text-xl font-bold text-center'>Selamat Datang di Dashboard</h2>";
